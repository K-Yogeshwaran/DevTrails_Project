...
function Register() {
    ...
    const verifyPlatform = async (platform) => {
        ...
        // Actual API call
        try {
            const res = await fetch(import.meta.env.VITE_PLATFORM_VERIFY_URL || "http://localhost:5001/api/platform/verify-user", {
                method: "POST",
        ...
        navigator.geolocation.getCurrentPosition(
            async (pos) => {
                try {
                    ...
                    const res = await fetch(import.meta.env.VITE_TRIGGER_API_URL + "/zones" || "http://localhost:5001/api/zones");
